...
def create_a_report():
    ...
    everything = [ ]
    #donor_db.sort(key=sort_donation, reverse=True) #do I not need this? I got a AttributeError: 'dict' object has no attribute 'sort'
    for donor_name, donations in donor_db: #I get an error saying too many values to unpack (expected 2)
